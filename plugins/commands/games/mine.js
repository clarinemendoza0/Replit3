...
const minerals = [
  { name: '𝘊𝘰𝘢𝘭', coinValue: getRandomValue(5000000, 1000000) },
  { name: '𝘐𝘳𝘰𝘯', coinValue: getRandomValue(1000000, 5000000) },
  { name: '𝘉𝘳𝘰𝘯𝘻𝘦', coinValue: getRandomValue(5000000, 1000000) },
  { name: '𝘚𝘪𝘭𝘷𝘦𝘳', coinValue: getRandomValue(10000000, 1500000) },
  { name: '𝙂𝙤𝙡𝙙', coinValue: getRandomValue(1500000, 20000000) },
  { name: '💎', coinValue: getRandomValue(2000000, 50000000) },
