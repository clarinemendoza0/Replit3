...
async function onCall({ message, args })  {
  ...
  try {
    ...
    message.reply('An error occurred while processing the request. Please try again later.');
  }
};
